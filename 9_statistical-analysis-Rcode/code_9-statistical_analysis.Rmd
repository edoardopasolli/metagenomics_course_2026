---
title: "Introduction to metagenomics 2026 - Statistical analysis"
...
## Install packages
- Here we install the missing third-party packages that we need later
...
bioconductor_packages <- c("curatedMetagenomicData", "ComplexHeatmap")

cran_packages <- c(
  "vegan", "dplyr", "ggplot2", "ggpubr", "tidyr", "tibble",
  "stringr", "circlize", "rstatix", "caret", "pROC"
)
